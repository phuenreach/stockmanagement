            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row mb-3">
                        ...
                        <div class="">
                        <input type="text" class="form-control shadow-none"  name="name" value="{{ old('name', $product[0]->name ) }}" >
                        @if($errors->has('name'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="">
                        <input type="number" class="form-control shadow-none" name="qty" value="{{ old('qty',$product[0]->quality) }}" min="0">
                        @if($errors->has('qty'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="">
                        <input type="number" class="form-control shadow-none" name="price" value="{{ old('price', $product[0]->unit_price) }}" min="0.01" step="0.01">
                        @if($errors->has('price'))
                            <span style="color: red; font-size:12px">សូមបំពេញ និង​ ជាប្រភេទលេខ </span>
                        @endif
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="">
                        <input type="text" class="form-control shadow-none" name="code" value="{{ old('code', $product[0]->code) }}">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select shadow-none" aria-label="Default select example" name="category_id">
                                    ...
                                    @foreach ($categories as  $item)
                                        <option value="{{ $item->id }}"  @if($product[0]->category_id == $item->id)
                                            selected
                    ...
                    <div class="row mb-3">
                        <fieldset class="form-group">
                            ...
                            <input type="text" id="pro-image" name="tmp_file[]"  class="form-control" value="{{ '' }}">
                        </fieldset>
                        <div class="preview-images-zone">
                            @php
                                $data =$product[0]->pro_galleries
                            @endphp
                            @foreach ($product[0]->pro_galleries as $item)

                            <div class="image-zone"><img id="pro-img-" src="{{ asset("uploads/product/".$item->img_name) }}"></div>
        ...
        <div class="modal-dialog">
          ...
          <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-outline-secondary shadow-none" data-bs-dismiss="modal">បោះបង់</button>
              <button type="button" class="btn btn-outline-primary shadow-none">រក្សាទុក</button>
            </div>
          </div>
        </div>
      </div>
